...
use uefi::{
    ...
    proto::device_path::{text::{AllowShortcuts, DisplayOnly}, DevicePath}, CString16,
};
...
pub fn get_default_dropin_directory(boot_services: &BootServices, loaded_image_file_path: &DevicePath, fs: &mut uefi::fs::FileSystem) -> uefi::Result<Option<PathBuf>> {
