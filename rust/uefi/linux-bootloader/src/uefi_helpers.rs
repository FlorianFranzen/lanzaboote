...
use uefi::{prelude::BootServices, proto::{loaded_image::LoadedImage, device_path::{FfiDevicePath, DevicePath}}, Result};
...
impl PeInMemory {
    ...
    pub fn file_path<'a>(&'a self) -> Option<&'a DevicePath> {
        // SAFETY:
        //
        ...
        // are guaranteed.
        unsafe { self.image_device_path.map(|ptr| DevicePath::from_ffi_ptr(ptr)) }
    }
}
